...
module privateEndpointOverlayRemote 'br/artifacts:network.private-endpoints:latest' = {
  name: '${name}-Remote'
  params: {
    location: location
    lock: lock
...
output resourceId string = privateEndpointOverlayRemote.outputs.resourceId

@description('The name of the private endpoint.')
output name string = privateEndpointOverlayRemote.outputs.name

@description('The location the resource was deployed into.')
output location string = privateEndpointOverlayRemote.outputs.location
