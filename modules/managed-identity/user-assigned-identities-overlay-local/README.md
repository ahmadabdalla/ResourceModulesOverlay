# User Assigned Identities (Overlay Local) `[Microsoft.ManagedIdentity/userAssignedIdentitiesOverlayLocal]`

This module deploys a user assigned identity (Overlay Local).
