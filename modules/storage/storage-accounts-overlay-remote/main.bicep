...
module storageAccountOverlayRemote 'br/artifacts:storage.storage-accounts:latest' = {
  name: '${name}-Remote'
  params: {
    name: name
    location: location
...
output resourceId string = storageAccountOverlayRemote.outputs.resourceId

@description('The name of the deployed storage account.')
output name string = storageAccountOverlayRemote.outputs.name

@description('The resource group of the deployed storage account.')
output resourceGroupName string = resourceGroup().name

@description('The primary blob endpoint reference if blob services are deployed.')
output primaryBlobEndpoint string = storageAccountOverlayRemote.outputs.name

@description('The principal ID of the system assigned identity.')
output systemAssignedPrincipalId string = systemAssignedIdentity && contains(storageAccountOverlayRemote.outputs, 'systemAssignedPrincipalId') ? storageAccountOverlayRemote.outputs.systemAssignedPrincipalId : ''

@description('The location the resource was deployed into.')
output location string = storageAccountOverlayRemote.outputs.location
